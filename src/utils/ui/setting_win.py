...
class Ui_SettingWin(object):
    def setupUi(self, SettingWin):
        ...
        self.check_is_save_check_box_status = QCheckBox(SettingWin)
        ...
        self.button_save_setting.clicked.connect(SettingWin.eventSaveSetting)
        self.button_cancel.clicked.connect(SettingWin.eventCancelSetting)
        self.check_is_save_check_box_status.clicked.connect(
            SettingWin.eventSaveCheckBoxStatus
        )
        self.button_reset_save_location.clicked.connect(
            SettingWin.eventResetSaveLocation
        )
        self.combo_background.currentTextChanged.connect(
            SettingWin.eventChooseBackgroundImg
        )
        self.button_open_background_dir.clicked.connect(
            SettingWin.eventOpenBackgroundDir
        )
        self.button_open_plugin_dir.clicked.connect(SettingWin.eventOpenPluginDir)
