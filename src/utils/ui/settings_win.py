...
class Ui_SettingsWin(object):
    def setupUi(self, SettingsWin):
        ...
        SettingsWin.resize(640, 480)
        SettingsWin.setMinimumSize(QSize(640, 480))
        SettingsWin.setMaximumSize(QSize(640, 480))
        SettingsWin.setStyleSheet(
            "/*\n"
        ...
        self.button_cancel = QPushButton(SettingsWin)
        ...
        self.button_save_setting = QPushButton(SettingsWin)
        ...
        self.layoutWidget = QWidget(SettingsWin)
        ...
        self.label_6 = QLabel(SettingsWin)
        ...
        self.combo_background = QComboBox(SettingsWin)
        ...
        self.label_3 = QLabel(SettingsWin)
        self.label_3.setObjectName("label_3")
        self.label_3.setGeometry(QRect(50, 330, 144, 21))
        self.label_3.setFont(font2)
        self.check_is_save_check_box_status = QCheckBox(SettingsWin)
        ...
        self.check_is_save_check_box_status.setFont(font4)
        self.check_is_save_check_box_status.setStyleSheet(
            "QCheckBox {\n"
            "	color: #000000;\n"
            "	padding: 2px;\n"
            "}\n"
        ...
        self.button_open_plugin_dir = QPushButton(SettingsWin)
        ...
        self.output_save_location = QTextEdit(SettingsWin)
        ...
        self.button_save_setting.clicked.connect(SettingsWin.eventSaveSettings)
        self.button_cancel.clicked.connect(SettingsWin.eventCancelSettings)
        self.check_is_save_check_box_status.clicked.connect(
            SettingsWin.eventSaveCheckBoxStatus
        )
    ...
    def retranslateUi(self, SettingsWin):
        ...
        self.label.setText(
            QCoreApplication.translate("SettingsWin", "\u8bbe\u7f6e", None)
        )
        self.label_6.setText(
            QCoreApplication.translate(
                "SettingsWin", "\u80cc\u666f\u56fe\u7247\u9009\u62e9", None
            )
        )
        ...
        self.check_is_save_check_box_status.setText("")
        self.button_open_background_dir.setText(
            QCoreApplication.translate("SettingsWin", "\u76ee\u5f55", None)
        )
        self.label_7.setText(
            QCoreApplication.translate(
                "SettingsWin", "\u63d2\u4ef6\u5b58\u653e\u76ee\u5f55", None
            )
        )
        self.button_open_plugin_dir.setText(
            QCoreApplication.translate(
                "SettingsWin", "\u6253\u5f00\u63d2\u4ef6\u5b58\u653e\u76ee\u5f55", None
            )
        )
