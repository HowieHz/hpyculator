...
"}")
        ...
        font2 = QFont()
        font2.setFamilies([u"\u7b49\u8ddd\u66f4\u7eb1\u9ed1\u4f53 Slab SC"])
        ...
        self.check_is_save_check_box_status.setObjectName(u"check_is_save_check_box_status")
        ...
        self.check_is_save_check_box_status.setStyleSheet(u"QCheckBox {\n"
"	color: #000000;\n"
"	padding: 2px;\n"
"}\n"
"QCheckBox:disabled {\n"
...
"}")
        ...
        self.button_open_background_dir.setObjectName(u"button_open_background_dir")
        ...
        self.button_open_plugin_dir.setObjectName(u"button_open_plugin_dir")
        ...
        self.check_is_save_check_box_status.clicked.connect(SettingsWin.eventSaveCheckBoxStatus)
        self.button_reset_save_location.clicked.connect(SettingsWin.eventResetSaveLocation)
        self.combo_background.activated.connect(SettingsWin.eventChooseBackgroundImg)
        self.button_open_background_dir.clicked.connect(SettingsWin.eventOpenBackgroundDir)
    ...
    def retranslateUi(self, SettingsWin):
        SettingsWin.setWindowTitle(QCoreApplication.translate("SettingsWin", u"Dialog", None))
        self.button_cancel.setText(QCoreApplication.translate("SettingsWin", u"\u53d6\u6d88\u4fee\u6539", None))
        self.button_save_setting.setText(QCoreApplication.translate("SettingsWin", u"\u4fdd\u5b58", None))
        self.label.setText(QCoreApplication.translate("SettingsWin", u"\u8bbe\u7f6e", None))
        self.label_6.setText(QCoreApplication.translate("SettingsWin", u"\u80cc\u666f\u56fe\u7247\u9009\u62e9", None))
        self.label_3.setText(QCoreApplication.translate("SettingsWin", u"\u662f\u5426\u4fdd\u5b58\u9009\u62e9\u6846\u72b6\u6001", None))
        self.check_is_save_check_box_status.setText("")
        self.button_open_background_dir.setText(QCoreApplication.translate("SettingsWin", u"\u76ee\u5f55", None))
        self.label_7.setText(QCoreApplication.translate("SettingsWin", u"\u63d2\u4ef6\u5b58\u653e\u76ee\u5f55", None))
        self.button_open_plugin_dir.setText(QCoreApplication.translate("SettingsWin", u"\u6253\u5f00\u63d2\u4ef6\u5b58\u653e\u76ee\u5f55", None))
        self.label_2.setText(QCoreApplication.translate("SettingsWin", u"\u4fdd\u5b58\u8f93\u51fa\u6587\u4ef6\u7684\u4f4d\u7f6e", None))
        self.button_reset_save_location.setText(QCoreApplication.translate("SettingsWin", u"\u91cd\u7f6e\u4fdd\u5b58\u4f4d\u7f6e", None))
        self.label_5.setText(QCoreApplication.translate("SettingsWin", u"\u91cd\u7f6e\u4fdd\u5b58\u4f4d\u7f6e", None))
    # retranslateUi
