...
class TestCalculationManager:
    ...
    def test_calculation_manager(
        ...
        ret = instance_main_window.eventStartCalculation(test_input=test_input, test_input_mode=test_input_mode, test_calculation_mode=test_calculation_mode, test_selection_id=test_selection_id, test_output_dir_path=test_output_dir_path)
