...
"}")
        ...
        self.check_is_save_check_box_status.clicked.connect(SettingWin.eventSaveCheckBoxStatus)
        self.button_reset_save_location.clicked.connect(SettingWin.eventResetSaveLocation)
        self.combo_background.currentTextChanged.connect(SettingWin.eventChooseBackgroundImg)
        self.button_open_background_dir.clicked.connect(SettingWin.eventOpenBackgroundDir)
    ...
    def retranslateUi(self, SettingWin):
        ...
        self.label_6.setText(QCoreApplication.translate("SettingWin", u"\u80cc\u666f\u56fe\u7247\u9009\u62e9", None))
        self.label_3.setText(QCoreApplication.translate("SettingWin", u"\u662f\u5426\u4fdd\u5b58\u9009\u62e9\u6846\u72b6\u6001", None))
        self.check_is_save_check_box_status.setText("")
        self.button_open_background_dir.setText(QCoreApplication.translate("SettingWin", u"\u76ee\u5f55", None))
        self.label_7.setText(QCoreApplication.translate("SettingWin", u"\u63d2\u4ef6\u5b58\u653e\u76ee\u5f55", None))
        self.button_open_plugin_dir.setText(QCoreApplication.translate("SettingWin", u"\u6253\u5f00\u63d2\u4ef6\u5b58\u653e\u76ee\u5f55", None))
