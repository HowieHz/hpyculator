...
class Ui_SettingWin(object):
    def setupUi(self, SettingWin):
        ...
        self.button_save_setting.clicked.connect(SettingWin.event_save_setting)
        self.button_cancel.clicked.connect(SettingWin.event_cancel_setting)
        self.check_is_save_check_box.clicked.connect(
            SettingWin.event_save_setting_check
        )
        self.button_reset_save_location.clicked.connect(
            SettingWin.event_reset_save_location
        )
        self.combo_background.currentTextChanged.connect(
            SettingWin.event_choose_background_img
        )
        self.button_open_background_dir.clicked.connect(
            SettingWin.event_open_background_dir
        )
        self.button_open_plugin_dir.clicked.connect(SettingWin.event_open_plugin_dir)
    ...
    def retranslateUi(self, SettingWin):
        ...
        self.combo_background.setItemText(
            0, QCoreApplication.translate("SettingWin", "\u672a\u5b8c\u5de5", None)
        )
