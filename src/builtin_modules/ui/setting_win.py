...
"}")
        ...
        self.check_is_save_check_box.clicked.connect(SettingWin.event_save_setting_check)
        self.button_reset_save_location.clicked.connect(SettingWin.event_reset_save_location)
        self.combo_background.currentTextChanged.connect(SettingWin.event_choose_background_img)
        self.button_open_background_dir.clicked.connect(SettingWin.event_open_background_dir)
    ...
    def retranslateUi(self, SettingWin):
        ...
        self.combo_background.setItemText(0, QCoreApplication.translate("SettingWin", u"\u672a\u5b8c\u5de5", None))
