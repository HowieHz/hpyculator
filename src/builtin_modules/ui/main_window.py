...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(":/ico/icons/ico.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        MainWindow.setStyleSheet(
            ...
            "	border-top-color: qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgb(215, 215, 215), stop:1 rgb(222, 222, 222));\n"
            "	border-right-color:"
            " qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0 rgb(217, 217, 217), stop:1 rgb(227, 227, 227));\n"
            "	border-left-color: qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0 rgb(227, 227, 227), stop:1 rgb(217, 217, 217));\n"
            "	border-bottom-color: qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgb(215, 215, 215), stop:1 rgb(222, 222, 222));\n"
            "	border-width: 1px;\n"
            "	border-radius: 5px;\n"
            ...
            "	border-right-color: qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0 rgb(217, 217, 217), stop:1 rgb(227, 227, 227));\n"
            "	border-left-color: qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0 rgb(227, 227, 227), stop:1 rgb(217, 217, 217));\n"
            "	border-bottom-color: qlineargradient(spread:pad, "
            "x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgb(215, 215, 215), stop:1 rgb(222, 222, 222));\n"
            "	border-width: 1px;\n"
            "	border-radius: 5px;\n"
            "	color: rgb(0,0,0);\n"
            "	padding: 2px;\n"
            ...
            "	border-style: solid;\n"
            "	border-top-color"
            ": qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgb(195, 195, 195), stop:1 rgb(222, 222, 222));\n"
            "	border-right-color: qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0 rgb(197, 197, 197), stop:1 rgb(227, 227, 227));\n"
            "	border-left-color: qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0 rgb(227, 227, 227), stop:1 rgb(197, 197, 197));\n"
            "	border-bottom-color: qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgb(195, 195, 195), stop:1 rgb(222, 222, 222));\n"
            "	border-width: 1px;\n"
            ...
            "	border-top-color: qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgb(215, 215, 215), stop:1 rgb(222, 222, 222));\n"
            "	border-right-color: qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0 rgb(217, 217, 217), stop:1 rgb(227, 227, 227));\n"
            "	border-left-color: qlineargradient(spre"
            "ad:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0 rgb(227, 227, 227), stop:1 rgb(217, 217, 217));\n"
            "	border-bottom-color: qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgb(215, 215, 215), stop:1 rgb(222, 222, 222));\n"
            "	border-width: 1px;\n"
            "	border-radius: 5px;\n"
            "	color: rgb(0,0,0);\n"
            ...
            "	background-color: qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgba(207, 209"
            ", 207, 255), stop:1 rgba(230, 229, 230, 255));\n"
            "}\n"
            "QMenuBar::item {\n"
            "	color: #000000;\n"
            "  	spacing: 3px;\n"
            ...
            "1, x2:0.5, y2:0, stop:0 rgba(0, 113, 255, 255), stop:1 rgba(91, 171, 252, 255));\n"
            "}\n"
            "\n"
            ...
            "	border-width: 1px;\n"
            "	bor"
            "der-color: qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgba(0, 113, 255, 255), stop:1 rgba(91, 171, 252, 255));\n"
            "}\n"
            "QTimeEdit {\n"
            "	border-style: solid;\n"
            "	border-width: 1px;\n"
        ...
        self.choices_list_box.setObjectName("choices_list_box")
        sizePolicy1 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
        sizePolicy1.setHorizontalStretch(2)
        sizePolicy1.setVerticalStretch(7)
        sizePolicy1.setHeightForWidth(
            self.choices_list_box.sizePolicy().hasHeightForWidth()
        )
        ...
        self.output_optimization_check.setObjectName("output_optimization_check")
        sizePolicy3.setHeightForWidth(
            self.output_optimization_check.sizePolicy().hasHeightForWidth()
        )
        ...
        self.output_lock_maximums_check.setObjectName("output_lock_maximums_check")
        sizePolicy3.setHeightForWidth(
            self.output_lock_maximums_check.sizePolicy().hasHeightForWidth()
        )
        ...
        self.about__menu.setObjectName("about__menu")
        self.reset_menu = QMenu(self.menu_bar)
        self.reset_menu.setObjectName("reset_menu")
        self.stop_menu = QMenu(self.menu_bar)
        self.stop_menu.setObjectName("stop_menu")
        ...
        QWidget.setTabOrder(
            self.output_optimization_check, self.output_lock_maximums_check
        )
        ...
        self.setting_menu.addAction(self.action)

        self.retranslateUi(MainWindow)
        self.start_button.clicked.connect(MainWindow.startEvent)
        self.save_check.clicked.connect(MainWindow.saveCheckEvent)
        self.output_optimization_check.clicked.connect(
            MainWindow.outputOptimizationCheckEvent
        )
        self.output_lock_maximums_check.clicked.connect(
            MainWindow.outputLockMaximumsCheckEvent
        )
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(
            QCoreApplication.translate("MainWindow", "hpycacular", None)
        )
        self.cheak_update.setText(
            QCoreApplication.translate("MainWindow", "\u66f4\u65b0\u65e5\u5fd7", None)
        )
        self.show_todo.setText(
            QCoreApplication.translate("MainWindow", "\u66f4\u65b0\u5c55\u671b", None)
        )
        self.show_about.setText(
            QCoreApplication.translate("MainWindow", "\u5f00\u5c4f\u4ecb\u7ecd", None)
        )
        self.show_update_log.setText(
            QCoreApplication.translate("MainWindow", "\u68c0\u67e5\u66f4\u65b0", None)
        )
        self.reset_save_location.setText(
            QCoreApplication.translate(
                "MainWindow", "\u91cd\u7f6e\u4fdd\u5b58\u8def\u5f84", None
            )
        )
        self.stop_compute.setText(
            QCoreApplication.translate(
                "MainWindow", "\u7ec8\u6b62\u5f53\u524d\u8fd0\u7b97", None
            )
        )
        self.stop_app.setText(
            QCoreApplication.translate("MainWindow", "\u9000\u51fa\u7a0b\u5e8f", None)
        )
        self.action.setText(
        ...
        self.start_button.setText(
            QCoreApplication.translate("MainWindow", "\u8ba1\u7b97", None)
        )
        self.save_check.setText(
            QCoreApplication.translate(
                "MainWindow", "\u4fdd\u5b58\u8f93\u51fa\u5230\u6587\u4ef6", None
            )
        )
        self.output_optimization_check.setText(
            QCoreApplication.translate(
                "MainWindow", "\u5185\u6846\u8f93\u51fa\u6027\u80fd\u4f18\u5316", None
            )
        )
        self.output_lock_maximums_check.setText(
            QCoreApplication.translate(
                "MainWindow", "\u5185\u6846\u8f93\u51fa\u4e0a\u9650", None
            )
        )
        self.about__menu.setTitle(
            QCoreApplication.translate("MainWindow", "|---\u5173\u4e8e---|", None)
        )
        self.reset_menu.setTitle(
            QCoreApplication.translate("MainWindow", "|---\u91cd\u7f6e---|", None)
        )
        self.stop_menu.setTitle(
            QCoreApplication.translate("MainWindow", "|---\u7ec8\u6b62---|", None)
        )
        self.setting_menu.setTitle(
            QCoreApplication.translate("MainWindow", "|---\u8bbe\u7f6e---|", None)
        )
