...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.button_about.sizePolicy().hasHeightForWidth())
...
"}")
        icon = QIcon()
        icon.addFile(u":/ico/icons/ico.ico", QSize(), QIcon.Normal, QIcon.On)
        ...
        sizePolicy2.setHeightForWidth(self.button_setting.sizePolicy().hasHeightForWidth())
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/ico/icons/setting_icon.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        sizePolicy2.setHeightForWidth(self.button_maximum.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy2.setHeightForWidth(self.button_close.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy3.setHeightForWidth(self.search_plugin.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy4.setHeightForWidth(self.list_choices_plugin.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy7.setHeightForWidth(self.check_output_lock_maximums.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy7.setHeightForWidth(self.check_output_optimization.sizePolicy().hasHeightForWidth())
        ...
        self.verticalSpacer_10 = QSpacerItem(20, 13, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.verticalLayout_2.addItem(self.verticalSpacer_10)

        self.check_auto_wrap = QCheckBox(MainWin)
        self.check_auto_wrap.setObjectName(u"check_auto_wrap")
        sizePolicy7.setHeightForWidth(self.check_auto_wrap.sizePolicy().hasHeightForWidth())
        ...
        self.check_auto_wrap.setStyleSheet(u"")
        ...
        sizePolicy8.setHeightForWidth(self.button_start.sizePolicy().hasHeightForWidth())
        ...
        self.button_close.clicked.connect(MainWin.event_quit)
        self.button_minimize.clicked.connect(MainWin.event_minimize)
        self.button_maximum.clicked.connect(MainWin.event_maximize)
        self.button_about.clicked.connect(MainWin.event_open_about_win)
        self.button_setting.clicked.connect(MainWin.event_open_setting_win)
        self.search_plugin.textChanged.connect(MainWin.event_search)
        self.list_choices_plugin.itemClicked.connect(MainWin.event_choose_option)
        self.button_start.clicked.connect(MainWin.event_start_calculation)
        self.check_output_optimization.clicked.connect(MainWin.event_output_optimization_check)
        self.check_output_lock_maximums.clicked.connect(MainWin.event_output_lock_maximums_check)
        self.check_save.clicked.connect(MainWin.event_save_check)
        self.check_auto_wrap.clicked.connect(MainWin.event_auto_wrap_check)
    ...
    def retranslateUi(self, MainWin):
        ...
        self.check_auto_wrap.setText(QCoreApplication.translate("MainWin", u"\u81ea\u52a8\u6362\u884c", None))
