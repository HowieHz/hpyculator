...
"}")
        ...
        self.check_output_optimization.clicked.connect(MainWin.eventOutputOptimizationCheck)
        self.check_output_lock_maximums.clicked.connect(MainWin.eventOutputLockMaximumsCheck)
