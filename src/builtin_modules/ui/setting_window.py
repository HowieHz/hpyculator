...
class Ui_SettingWindow(object):
    def setupUi(self, SettingWindow):
        ...
        font1 = QFont()
        font1.setFamilies(["\u7b49\u8ddd\u66f4\u7eb1\u9ed1\u4f53 Slab SC"])
        font1.setPointSize(12)
        self.label_2.setFont(font1)
        self.cancel_setting_button = QPushButton(SettingWindow)
        self.cancel_setting_button.setObjectName("cancel_setting_button")
        ...
        self.save_setting_check.setObjectName("save_setting_check")
        self.save_setting_check.setGeometry(QRect(230, 210, 121, 21))
        font3 = QFont()
        font3.setFamilies(["\u66f4\u7eb1\u9ed1\u4f53 SC"])
        font3.setPointSize(12)
        self.save_setting_check.setFont(font3)
        self.save_setting_check.setStyleSheet(
            "QCheckBox {\n"
            "	color: #000000;\n"
            "	padding: 2px;\n"
            "}\n"
    ...
    def retranslateUi(self, SettingWindow):
        SettingWindow.setWindowTitle(
            QCoreApplication.translate("SettingWindow", "Dialog", None)
        )
        self.label.setText(
            QCoreApplication.translate("SettingWindow", "\u8bbe\u7f6e", None)
        )
        ...
        self.cancel_setting_button.setText(
            QCoreApplication.translate(
                "SettingWindow", "\u53d6\u6d88\u4fee\u6539", None
            )
        )
        self.save_setting_button.setText(
            QCoreApplication.translate("SettingWindow", "\u4fdd\u5b58", None)
        )
